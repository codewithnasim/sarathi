...
const ViewDriverProfile = ({ route }) => {
  ...
  useEffect(() => {
    const fetchDriverDetails = async () => {
      try {
        ...
        const response = await fetch(`https://sarathi-backend-file.onrender.com/api/drivers/email/${storedEmail}`);
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      {/* Profile Image */}
      <Image
        source={driver.photo ? { uri: `https://sarathi-backend-file.onrender.com${driver.photo}` } : require("./pic/d.png")}
      ...
      <View style={styles.infoContainer}>
        ...
        <Text style={styles.info}>🔰 Experience: {driver.experience} years</Text>
